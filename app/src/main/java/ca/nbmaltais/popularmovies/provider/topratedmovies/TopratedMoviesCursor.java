...
/**
 * Cursor wrapper for the {@code toprated_movies} table.
 */
public class TopratedMoviesCursor extends AbstractCursor implements TopratedMoviesModel {
    public TopratedMoviesCursor(Cursor cursor) {
        super(cursor);
    }
     ...
     */
    public long getId() {
        Long res = getLongOrNull(TopratedMoviesColumns._ID);
        if (res == null)
    ...
    public long getMovieId() {
        Long res = getLongOrNull(TopratedMoviesColumns.MOVIE_ID);
        if (res == null)
