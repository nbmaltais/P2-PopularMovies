...
/**
 * Cursor wrapper for the {@code upcoming_movies} table.
 */
public class UpcomingMoviesCursor extends AbstractCursor implements UpcomingMoviesModel {
    public UpcomingMoviesCursor(Cursor cursor) {
        super(cursor);
    }
     ...
     */
    public long getId() {
        Long res = getLongOrNull(UpcomingMoviesColumns._ID);
        if (res == null)
    ...
    public long getMovieId() {
        Long res = getLongOrNull(UpcomingMoviesColumns.MOVIE_ID);
        if (res == null)
